...
this.bksvc.sendcommand((f)=>{ this.bksvc.timeoff.AvailableWorkDays=f},"GetEmployeeAvailableWorkDays","start="+ this.bksvc.datetime(s)+"&days="+this.bksvc.encript(""+this.bksvc.timeoff.days)+"&hours="+this.bksvc.encript(""+this.bksvc.timeoff.hours),{ withCredentials: true});
